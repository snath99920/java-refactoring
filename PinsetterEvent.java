...
public class PinsetterEvent {
     ...
     */
    public PinsetterEvent(final boolean[] pinSet, final boolean foul, final int throwNum, final int pinsDownThisThrow) {
        pinsStillStanding = new boolean[10];

        for (int i=0; i <= 9; i++) {
            pinsStillStanding[i] = pinSet[i];
        }
     ...
     */
    public boolean pinKnockedDown(final int pin) {
        return !pinsStillStanding[pin];
    }
