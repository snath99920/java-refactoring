...
//    private HashMap scores;
    ...
    public static int calculateScore(final Bowler PlayerCur, final int frame, final int[][] cumulScores, int ball, HashMap scores, int bowlIndex) {

//        this.cumulScores = cumulScores;
        int[] curScore;
        int strikeballs = 0;
        int totalScore = 0;
        curScore = (int[]) scores.get(PlayerCur);
        for (int i = 0; i != 10; i++) {
